...
public class ItemRegistries {
    ...
    //Soup N Stew
    public static final RegistryObject<Item> VEGGIE_SOUP = ITEMS.register("veggie_soup", () -> new Item(new Item.Properties().food(FnFFoodProperties.VEGGIE_SOUP)));
    public static final RegistryObject<Item> MUSHROOM_CHICKEN_STEW = ITEMS.register("mushroom_chicken_stew", () -> new Item(new Item.Properties().food(FnFFoodProperties.MUSHROOM_CHICKEN_STEW)));
    public static final RegistryObject<Item> MUSHROOM_MUTTON_STEW = ITEMS.register("mushroom_mutton_stew", () -> new Item(new Item.Properties().food(FnFFoodProperties.MUSHROOM_MUTTON_STEW)));
    public static final RegistryObject<Item> MUSHROOM_BEEF_STEW = ITEMS.register("mushroom_beef_stew", () -> new Item(new Item.Properties().food(FnFFoodProperties.MUSHROOM_BEEF_STEW)));
    public static final RegistryObject<Item> MUSHROOM_PORK_STEW = ITEMS.register("mushroom_pork_stew", () -> new Item(new Item.Properties().food(FnFFoodProperties.MUSHROOM_PORK_STEW)));
    public static final RegistryObject<Item> PIPING_HOT_VEGGIE_SOUP = ITEMS.register("piping_hot_veggie_soup", () -> new Item(new Item.Properties().food(FnFFoodProperties.PIPING_HOT_VEGGIE_SOUP)));
    public static final RegistryObject<Item> PIPING_HOT_BEETROOT_SOUP = ITEMS.register("piping_hot_beetroot_soup", () -> new Item(new Item.Properties().food(FnFFoodProperties.PIPING_HOT_BEETROOT_SOUP)));
    public static final RegistryObject<Item> PIPING_HOT_MUSHROOM_STEW = ITEMS.register("piping_hot_mushroom_stew", () -> new Item(new Item.Properties().food(FnFFoodProperties.PIPING_HOT_MUSHROOM_STEW)));
    public static final RegistryObject<Item> PIPING_HOT_RABBIT_STEW = ITEMS.register("piping_hot_rabbit_stew", () -> new Item(new Item.Properties().food(FnFFoodProperties.PIPING_HOT_RABBIT_STEW)));
    public static final RegistryObject<Item> MINERS_DELIGHT = ITEMS.register("miners_delight", () -> new Item(new Item.Properties().food(FnFFoodProperties.MINERS_DELIGHT)));
    public static final RegistryObject<Item> FARMERS_GRACE = ITEMS.register("farmers_grace", () -> new Item(new Item.Properties().food(FnFFoodProperties.FARMERS_GRACE)));
    public static final RegistryObject<Item> NETHER_DWELLERS_SUBSISTENCE = ITEMS.register("nether_dwellers_subsistence", () -> new Item(new Item.Properties().food(FnFFoodProperties.NETHER_DWELLERS_SUBSISTENCE)));
    public static final RegistryObject<Item> HIGHLANDERS_MEAL = ITEMS.register("highlanders_meal", () -> new Item(new Item.Properties().food(FnFFoodProperties.HIGHLANDERS_MEAL)));
    public static final RegistryObject<Item> EXPLORERS_FANCY_COOKING = ITEMS.register("explorers_fancy_cooking", () -> new Item(new Item.Properties().food(FnFFoodProperties.EXPLORERS_FANCY_COOKING)));
    public static final RegistryObject<Item> LUCKY_STAR = ITEMS.register("lucky_star", () -> new Item(new Item.Properties().food(FnFFoodProperties.LUCKY_STAR)));
    public static final RegistryObject<Item> FISHERMANS_SECRET_BROTH = ITEMS.register("fishermans_secret_broth", () -> new Item(new Item.Properties().food(FnFFoodProperties.FISHERMANS_SECRET_BROTH)));
